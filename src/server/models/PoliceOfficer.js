...
const PoliceOfficer = mySequelize.define('police_officer', {
  ...
  extPoliceId: {
    ...
    validate: {
      len: {
        args: [2, 50],
        msg: 'Please provide a Police Id with at least 2 char but not more than 50',
      },
    },
  },
  firstName: {
  ...
  isActive: { // This is to active/inactive the police officer
    type: Sequelize.BOOLEAN,
    defaultValue: true,
  },
  isBusy: { // This tells whether policeman is assigned with case or free
    type: Sequelize.BOOLEAN,
    defaultValue: false,
  },
  createdAt: {
